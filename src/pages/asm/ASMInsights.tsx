...
const insights: Insight[] = [
  ...
  },
  {
    ...
    title: "Asian Paints is locking-in retailers with Primer SKUs by bundling with Paints",
    summary:
      "Sudden spike in Asian Paints Primer SKUs in Pimpri Chinchwad.\nRetailers are getting attractive schemes on Paints only if they buy bundled Primer purchases above 50 units.\nOur retailers report this is changing their decision on monthly primer orders.",
  ...
  },
  {
    ...
    marketArea: "Pune NE",
    title: "[Positive Feedback] Our Paint Users Happy with Shade Consistencies – This can be part of core value proposition / campaigns",
    summary:
      "Painters are highlighting consistent coverage and zero shade variation in our paint products. This is leading to optimal material consumption & even finish, especially on larger surfaces. This can be part of our core value proposition – or ad campaigns.",
  ...
  },
  {
    ...
    title: "Retailers pull back on our Primer orders over packaging concerns",
    summary:
      "Ahead of the monsoon season, retailers are signaling reluctance to stock our Primer due to ongoing packaging issues. They report that the product’s single-layer packaging fails to withstand high moisture levels during the monsoon, leading to rapid deterioration in quality and rendering the product unusable.",
    tags: ["packaging", "primer", "monsoon"],
    trend: "down",
    reportedAt: "16 Apr",
  ...
  },
  {
    ...
    category: "Contractor",
    marketArea: "Pune SW",
    title: "Many Contractors in Pune are switching to our Primer for ‘premium interior repaint jobs’",
    summary:
      "Contractors report choosing our Primer more often in repainting of premium flats and bungalows where homeowners are sensitive to wall feel and lighting appearance. Helps them achieve a cleaner final paint finish with fewer visible surface marks.\n(other locations can also leverage this insight)",
