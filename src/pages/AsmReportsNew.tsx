    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-screen-xl mx-auto px-6 py-6">
        ...
        <header className="flex justify-between items-start mb-4">
          ...
          <button
            onClick={() => navigate("/asm-dashboard-new")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-card border rounded-lg p-4">
            <h2 className="text-[15px] font-bold text-foreground">
              1. Engagement Reports <span className="font-normal text-muted-foreground">(Area-level)</span>
            </h2>
          ...
          <div className="bg-card border rounded-lg p-4">
            <h2 className="text-[15px] font-bold text-foreground mb-3">
              3. Top Retailer Objections <span className="font-normal text-muted-foreground">(in the area)</span>
            </h2>
