...
const reports: Report[] = [
  { id: 1, me: "Arjun M.", retailer: "Sharma Hardware & Paints", region: "Wakad", date: "May 5", products: ["White Cement", "Putty"],
    objections: [
      { text: "Putty settling time inconsistency from last 2 batches", cat: "Product quality", action: "Shared tech spec sheet, escalated batch to QC", status: "agreed" },
      { text: "Requesting Putty cashback extension beyond May 15", cat: "Competition", action: "Flagged to ASM for scheme team follow-up", status: "pending" },
    ],
    insights: ["UltraTech rep visited yesterday with 3% extra discount offer", "Housing project sector 67 — bulk orders likely by June"],
    meNote: "Strong advocate. High potential for Paints cross-sell." },
  { id: 2, me: "Arjun M.", retailer: "Gupta Brothers Traders", region: "Wakad", date: "May 5", products: ["White Cement", "JK Paints"],
    objections: [
      { text: "Wants better bulk pricing for White Cement above 500 bags", cat: "Working capital", action: "Referred to ASM — approval required", status: "pending" },
      { text: "No JK Paints SKUs — shelf space needs to be created", cat: "SKU space", action: "Agreed to trial 2 SKUs — delivery within 5 days", status: "agreed" },
    ],
    insights: ["Customers asking for JK Paints by name — 8 times this month"],
    meNote: "Priority account. Bulk pricing approval could lock in volume." },
  { id: 3, me: "Priya S.", retailer: "Modi Building Materials", region: "Kothrud", date: "May 5", products: ["Putty", "JK Paints"],
    objections: [
      { text: "JK Paints not moving — customers ask for Asian Paints", cat: "Demand", action: "Discussed painter program, offered display standee", status: "agreed" },
    ...
    insights: ["Asian Paints has in-store display unit — JK Paints has none"],
    meNote: "Display investment here has cluster effect across 4 nearby shops." },
  { id: 4, me: "Ravi K.", retailer: "Agarwal Cement Store", region: "Hadapsar", date: "May 4", products: ["White Cement"],
    objections: [
      { text: "Birla White offering free painter training — grassroots pull", cat: "Competition", action: "Discussed JK Neev program, shared brochure", status: "agreed" },
      { text: "No active scheme on White Cement", cat: "Competition", action: "Logged for scheme team — no commitment given", status: "pending" },
    ],
    insights: ["Birla White ran painter training last Friday", "Contractor demand up ~30% vs same period last year"],
    meNote: "Trade activation urgently needed in Hadapsar." },
  { id: 5, me: "Sunita P.", retailer: "Krishnamurthy & Sons", region: "Pimpri", date: "May 4", products: ["Putty", "White Cement", "JK Paints"],
    objections: [
    ...
    insights: ["JK Paints texture finish enquiries increasing past month"],
    meNote: "Display unit here would be high-ROI. Retailer willing." },
  { id: 6, me: "Deepak R.", retailer: "Verma Paint Centre", region: "Chinchwad", date: "May 3", products: ["JK Paints"],
    objections: [
  ...
  { id: 7, me: "Kavita B.", retailer: "Jain Hardware Mart", region: "Shivajinagar", date: "May 3", products: ["Putty"],
    objections: [
      { text: "Local plasterers recommending competitor Putty", cat: "Competition", action: "Escalated plasterer engagement program need to ASM", status: "pending" },
      { text: "Demand dip for Putty vs same period last year", cat: "Demand", action: "Shared seasonal data — rise expected post-monsoon", status: "agreed" },
    ],
    insights: ["New regional Putty brand nearby — ₹320/bag vs JK ₹390"],
    meNote: "Critical — plasterer influence can cascade rapidly." },
  { id: 8, me: "Manish T.", retailer: "Rawat Building Supplies", region: "Kondhwa", date: "Apr 30", products: ["White Cement", "Putty"],
    objections: [
      { text: "Delivery delays — lost 2 sales last week", cat: "Working capital", action: "Escalated, shared logistics contact", status: "agreed" },
      { text: "UltraTech visited with aggressive pricing", cat: "Competition", action: "No counter-offer — requested scheme team guidance", status: "pending" },
    ],
    insights: ["2 regular contractors switched to UltraTech this month"],
